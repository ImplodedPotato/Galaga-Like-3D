...
Galaga3D: raylib
ifneq (,$(Galaga3D_config))
	@echo "==== Building Galaga3D ($(Galaga3D_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Galaga3D.make config=$(Galaga3D_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Galaga3D.make clean
